class Hero {
    ...
    setAttribs(race, clase) {
        ...
        for (let i = 0; i < 3; i++) {
            attribs[i] = racePoints[race][i] + classPoints[clase][i];
        }
    ...
    setExp(exp) {
        this.exp += exp;
        const lvlUp = [200, 400, 800, 1600, 3200, 6400, 12000];
    ...
    setStrength() {
        this.health = ((this.strength * 2.5) + (this.agility * 1.8) + (this.intelligence * 1.8) + (this.lvl * .3)).toFixed(2);
        this.damage = ((this.strength * 1.5) + (this.agility * .8) + (this.intelligence * .8) + (this.lvl * .3)).toFixed(2);
        ...
        this.armor = ((this.strength * .1) + (this.agility * .08) + (this.intelligence * .05) + (this.lvl * .3)).toFixed(2);
        this.critic = ((this.strength * .1) + (this.agility * .08) + (this.intelligence * .05) + (this.lvl * .3)).toFixed(2);
    }
    setAgility() {
        this.health = ((this.agility * 2) + (this.strength * 1.6) + (this.intelligence * 1.2) + (this.lvl * .3)).toFixed(2);
        this.damage = ((this.agility * 1) + (this.strength * .8) + (this.intelligence * .4) + (this.lvl * .3)).toFixed(2);
        ...
        this.armor = ((this.agility * .2) + (this.strength * .16) + (this.intelligence * .16) + (this.lvl * .3)).toFixed(2);
        this.critic = ((this.agility * .15) + (this.strength * .1) + (this.intelligence * .1) + (this.lvl * .3)).toFixed(2);
    }
    setIntelligence() {
        this.health = ((this.intelligence * 2) + (this.strength * 1.6) + (this.agility * 1.2) + (this.lvl * .3)).toFixed(2);
        this.damage = ((this.intelligence * 1) + (this.strength * .8) + (this.agility * .4) + (this.lvl * .3)).toFixed(2);

        this.mana = ((this.intelligence * 1.5) + (this.strength * 1.2) + (this.agility * 1.2) + (this.lvl * .3)).toFixed(2);
        this.magic = ((this.intelligence * .18) + (this.strength * .08) + (this.agility * .08) + (this.lvl * .3)).toFixed(2);

        this.armor = ((this.intelligence * .1) + (this.strength * .05) + (this.agility * .08) + (this.lvl * .3)).toFixed(2);
        this.critic = ((this.intelligence * .1) + (this.strength * .05) + (this.agility * .08) + (this.lvl * .3)).toFixed(2);
    }
}
